...
public class RequestListFactoryImplTest {
    ...
    public void createRequestList(){
        ...
        GetExemptionStatusesType exemptinStatuses = createGetExemptionStatusesType(RR_ID, Collections.<String> emptyList());
        QueryObject queryObject = new QueryObject(fc, exemptinStatuses);
        ...
        GetExemptionStatusesType request1 = (GetExemptionStatusesType)requestList.get(0)[1];
        ...
        GetExemptionStatusesType request2 = (GetExemptionStatusesType)requestList.get(1)[1];
    ...
    public void createRequestList_one_careUnit(){
        RequestListFactoryImpl requestFactory = new RequestListFactoryImpl();
        FindContentType fc = createFindContent(RR_ID);
        GetExemptionStatusesType exemptinStatuses = createGetExemptionStatusesType(RR_ID, Collections.singletonList(TestProducerDb.TEST_LOGICAL_ADDRESS_1));
        QueryObject queryObject = new QueryObject(fc, exemptinStatuses);
        ...
        GetExemptionStatusesType request = (GetExemptionStatusesType)requestList.get(0)[1];
    ...
    public void createRequestList_timePeriod(){
        ...
        // exemptinStatuses.setTimePeriod(timePeriod);
        QueryObject queryObject = new QueryObject(fc, exemptinStatuses);
        FindContentResponseType findContentResponse = createFindContentResponse(TestProducerDb.TEST_LOGICAL_ADDRESS_1, TestProducerDb.TEST_LOGICAL_ADDRESS_2);
    ...
    private GetExemptionStatusesType createGetExemptionStatusesType(String id, List<String> careUnits){
    	GetExemptionStatusesType exemptinStatuses = new GetExemptionStatusesType();
        IIType patientId = new IIType();
        patientId.setExtension(RR_ID);
        exemptinStatuses.setPatientId(patientId);
        // exemptinStatuses.getCareUnitHSAid().addAll(careUnits);
        return exemptinStatuses;
    }
