 ...
 */
package se.skltp.aggregatingservices.riv.financial.patientfees.exemption;
...
public class GetAggregatedExemptionStatusesTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedExemptionStatuses-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedExemptionStatusesTeststubMuleServer.class);
